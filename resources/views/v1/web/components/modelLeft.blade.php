        ...
        <div class="modal-content slim-scroll3 ps">
            <div class="modal-body p-30 bg-white">
                <div class="d-flex align-items-center justify-content-between pb-30">
                    ...
                    <a href="{{$link}}" class="btn btn-icon btn-danger-light btn-sm no-shadow"
                ...
                <div>
                    <div class="d-flex flex-row">
                        <div class=""><img src="/assets/images/avatar/avatar-13.png" alt="user"
                                           class="rounded bg-danger-light w-150" width="100"></div>
                        <div class="ps-20">
                            <h5 class="mb-0">Nil Yeager</h5>
                            <p class="my-5 text-fade">Manager</p>
                            <a href="mailto:dummy@gmail.com"><span class="icon-Mail-notification me-5 text-success"><span
                                        class="path1"></span><span class="path2"></span></span> dummy@gmail.com</a>
                            <button class="btn btn-success-light btn-sm mt-5"><i class="ti-plus"></i> Follow
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="media-list">
                        <a class="media media-single px-0" href="{{$link}}">
