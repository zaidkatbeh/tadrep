        ...
        <div class="chat-box-header p-15 d-flex justify-content-between align-items-center">
            <div class="btn-group">
                ...
                <div class="dropdown-menu min-w-200">
                    <a class="dropdown-item fs-16" href="extra_calendar.html#">
            ...
            <div class="chat-logs">
                <div class="chat-msg user">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="mx-10">
                            <a href="extra_calendar.html#" class="text-dark hover-primary fw-bold">Mayra Sibley</a>
                ...
                <div class="chat-msg self">
                    <div class="d-flex align-items-center justify-content-end">
                        <div class="mx-10">
                            <a href="extra_calendar.html#" class="text-dark hover-primary fw-bold">You</a>
